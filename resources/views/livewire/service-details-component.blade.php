                            ...
                            <div class="col-md-4">
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;"><span>&#36;</span> {{number_format($service->price)}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Quntity</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>&#36;</span> {{number_format($total)}}</td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <aside>
                                    ...
                                    <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                        ...
                                        <a href="{{route('home.service_details',['slug'=>$related_service->slug])}}">
                                            <div class="img-hover">
                                            ...
                                            <div class="info-gallery">
                                                ...
                                                <div class="content-btn"><a href="{{route('home.service_details',['slug'=>$related_service->slug])}}"
